package com.example.online_shope.Activity.listItem
...
import com.example.online_shope.Activity.Dashboard.ListItemsFullSizeVertical
...
fun ListItemScreen(
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        if (isLoading) {
            ...
            ListItemsFullSizeVertical(items, navController)
        }
